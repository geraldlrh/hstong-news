...
// ==UserScript==
// @name           hstong-news
// @namespace      https://github.com/geraldlrh/hstong-news
// @version        0.1.0
// @author         gerald
// @description    get hstong news
// @include        https://www.hstong.com/*
// @run-at         document-end
// @updateURL      https://github.com/geraldlrh/hstong-news/main.user.js
// @downloadURL    https://github.com/geraldlrh/hstong-news/main.user.js
...
(function () {
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$8(fn = input.toString) && !isObject$3(val = fn.call(input))) return val;
	  if (isCallable$8(fn = input.valueOf) && !isObject$3(val = fn.call(input))) return val;
	  if (pref !== 'string' && isCallable$8(fn = input.toString) && !isObject$3(val = fn.call(input))) return val;
	...
	if (NATIVE_WEAK_MAP || shared.state) {
	  ...
	  set = function (it, metadata) {
	    if (hasOwn$9(it, STATE)) throw new TypeError(OBJECT_ALREADY_INITIALIZED);
	    metadata.facade = it;
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$4 ? $getOwnPropertyDescriptor : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$8(O, P)) return createPropertyDescriptor$3(!propertyIsEnumerableModule$1.f.call(O, P), O[P]);
	};
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$5(hiddenKeys$2, key) && hasOwn$5(O, key) && result.push(key);
	...
	*/
	...
	var getIterator$2 = function (argument, usingIterator) {
	  ...
	  if (aCallable(iteratorMethod)) return anObject$1(iteratorMethod.call(argument));
	  ...
	  if (window.confirm("是否开始下载24小时以内的咨询")) {
	    getData(0, function (res) {
	      if (res.data.length) {
	        ...
	        CONTROL.endTimeStamp = endTime.getTime(); // console.info("endTimeStamp", CONTROL.endTimeStamp);
	        // 开始爬取
	...
	const getNextData = function (sinceId) {
	  getData(sinceId, function (res) {
	    if (res.data.length) {
	      result = result.concat(res.data);
	      const lastItem = res.data[res.data.length - 1];
	      console.info("lastItem.createdDate", lastItem.createdDate, CONTROL.endTimeStamp);
